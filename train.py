...
def train(args):
    ...
    if args.init_checkpoint and args.init_checkpoint != "":
        ...
        init_pretraining_params(exe, args.init_checkpoint, train_program, args.use_amp)
